...
from src.features.encoding import build_preprocessor, split_features_target
from src.models.baseline import get_baseline_estimator
from src.models.catboost import HAS_CATBOOST, catboost_param_grid, get_catboost_estimator
from src.models.logistic import get_logistic_estimator, logistic_param_grid
from src.models.random_forest import get_random_forest_estimator, random_forest_param_grid
...
def _model_registry(random_state: int) -> dict[str, tuple[Any, dict]]:
	return {
		...
		"logistic": (get_logistic_estimator(random_state=random_state), logistic_param_grid()),
		"random_forest": (
			get_random_forest_estimator(random_state=random_state),
			random_forest_param_grid(),
		),
		"xgboost": (get_xgboost_estimator(random_state=random_state), xgboost_param_grid()),
		"catboost": (get_catboost_estimator(random_state=random_state), catboost_param_grid()),
	}
