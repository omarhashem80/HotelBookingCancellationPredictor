...
def show(df):
    ...
    with tab1:
        ...
        with col1:
            ...
            load_image_plot(
                univariate_plots / "adr_dist_histogram_box_plot.png"
            )
        ...
        with col2:
            ...
            load_image_plot(
                univariate_plots / "is_canceled_dist_pie_chart.png"
            )
            ...
            load_image_plot(
                univariate_plots / "deposit_type_dist_pie_chart.png"
            )
            ...
            load_image_plot(
                univariate_plots / "customer_type_dist_pie_chart.png"
            )
    ...
    with tab2:
        ...
        with col1:
            ...
            load_image_plot(
                bivariate_plots / "deposit_type_cancellation_bar.png"
            )
            ...
            load_image_plot(
                bivariate_plots / "customer_type_cancellation_bar.png"
            )
            ...
            load_image_plot(
                bivariate_plots
                / "stays_in_weekend_nights_cancellation_bar.png"
            )
    ...
    with tab4:
        ...
        load_image_plot(
            univariate_plots / "yearly_comparsion_arrival_date.png"
        )
